    ...
    <aside className="flex w-full shrink-0 flex-col border-r border-border bg-neutral-1 md:w-64">
      ...
      <div className="border-t border-border">
        ...
        <Link
          href="/about"
          title="关于"
          className="flex items-center gap-1.5 border-t border-border px-4 py-2 text-copy-13 text-neutral-6 transition-colors hover:bg-neutral-2 hover:text-neutral-9"
        >
        ...
        <button
          onClick={async () => {
            ...
            // eslint-disable-next-line @next/next/no-location-assign-relative-destination -- intentional full reload to clear client state
